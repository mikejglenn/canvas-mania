(function e(t, n, r) {
        ...
        var DrawMap = (function(_Phaser$State) {
            ...
            _createClass(DrawMap, [{
                ...
                value: function create() {
                    ...
                    this.add.tween(metroid.samus).to({
                        x: (2 + 5) * 16 * 16
    ...
    14: [function(require, module, exports) {
        ...
        */
        ...
        "../enemies/Zeb": 9,
        "../shared/Controls": 11,
        "../shared/roomTransition": 12,
        "../stuff/Block": 18,
        "../stuff/Door": 20,
        "../stuff/HUD": 21,
        "../stuff/MetroidMap": 23,
        "../stuff/PauseControl": 24,
        "../stuff/Pickup": 25,
        "../stuff/Pool": 26,
        "../stuff/Samus": 27,
        "../stuff/Weapons": 28,
            ...
            _createClass(Door, [{
                ...
                value: function runElevator() {
                    ...
                    samusTween.onComplete.add(function() {
                        metroid.samus.appeared = true;
                        metroid.samus.body.allowGravity = true;
                        metroid.game.state.states.GameState.roomTransition.unloadRoom({
                            x: -1,
                            x2: -1
                        });
        ...
        var MapParser = (function() {
            ...
            _createClass(MapParser, [{
                ...
                value: function index2coords(i) {
                    var coords = {
                        y: Math.floor(i / metroid.game.cache._cache.tilemap.map.data.width)
                    };
                    coords.x = i - coords.y;
                    return coords;
                }
                ...
                value: function createPassages2() {
                    ...
                    for (var i = 0; i < mapData.layers[4].objects.length; i++) {
                        ...
                        seeds.push({
                            x: Math.round(l.x / mapData.tilewidth),
                            y: Math.round(l.y / mapData.tileheight),
